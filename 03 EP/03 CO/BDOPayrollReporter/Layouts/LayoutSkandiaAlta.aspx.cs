...
{
    public partial class LayoutSkandiaAlta : System.Web.UI.Page
    {
                ...
                if (Utilities.IsNumeric(this.DropDownListAño.SelectedValue))
                {
                    if (Utilities.IsNumeric(this.DropDownListPeriodo.SelectedValue))
                    {
                        ...
                        if (Utilities.ValidarAño(año))
                        {
                            ...
                            {
                                file = TextHelper.RenderLayoutSkandiaAlta(año, mes);

                                if (file.Length > 0)
                                {
                                    this.LabelMensaje.Text = "";
                                    Response.Clear();
                                    string fileName = Utilities.GetName(ReportName.Layoutdealtasskandia, año, mes);
