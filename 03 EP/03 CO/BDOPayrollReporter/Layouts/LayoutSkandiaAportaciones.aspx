<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LayoutSkandiaAportaciones.aspx.cs"
    Inherits="BDOPayrollReporter.Layouts.LayoutSkandiaAportaciones" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Layout de aportaciones Skandia</h2>
            <table width="100%">
                <tr>
                    <td>
                        Año:
