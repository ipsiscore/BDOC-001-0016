<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LayoutInboundSap.aspx.cs"
    Inherits="BDOPayrollReporter.Layouts.LayoutInboundSap" MasterPageFile="~/MasterPages/Default.Master"
        ...
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="date" ID="TextBoxFechaNomina" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
