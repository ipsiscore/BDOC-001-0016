<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LayoutSiVale.aspx.cs" Inherits="BDOPayrollReporter.Layouts.LayoutSiVale"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Layout de SíVale Carga de Saldos</h2>
            <table width="100%">
                <tr>
                    <td>
                        Año:
