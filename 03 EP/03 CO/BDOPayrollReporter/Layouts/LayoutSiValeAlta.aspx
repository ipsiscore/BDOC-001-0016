<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LayoutSiValeAlta.aspx.cs"
    Inherits="BDOPayrollReporter.Layouts.LayoutSiValeAlta" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Layout de SíVale Solicitud de Tarjetas</h2>
            <table width="100%">
                <tr>
                    <td>
                        Año:
