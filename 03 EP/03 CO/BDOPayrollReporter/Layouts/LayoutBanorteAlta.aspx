<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LayoutBanorteAlta.aspx.cs"
    Inherits="BDOPayrollReporter.Layouts.LayoutBanorteAlta" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Layout de altas de Banorte</h2>
            <table width="100%">
                <tr>
                    <td>
                        Layout para subir a BANORTE
                    </td>
                </tr>
                <tr>
                    <td>
