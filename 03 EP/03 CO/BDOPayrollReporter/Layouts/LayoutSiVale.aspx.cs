...
{
    public partial class LayoutSiVale : System.Web.UI.Page
    {
                    ...
                    if (Utilities.IsNumeric(this.DropDownListPeriodo.SelectedValue))
                    {
                        ...
                        if (Utilities.ValidarAño(año))
                        {
                            if (Utilities.ValidarMes(mes))
                            {
                                ...
                                {
                                    file = TextHelper.RenderLayoutSiVale(año, mes, DateTime.Parse(this.TextBoxFechaDispesion.Text), tipo, !DropDownListEstadoNomina.SelectedValue.Equals("0") ? true : false);

                                    if (file.Length > 0)
                                    {
                                        this.LabelMensaje.Text = "";
                                        Response.Clear();
                                        string fileName = Utilities.GetName(ReportName.Layoutdesivalecargadesaldos, año, mes);
                                        ...
                                        this.LabelMensaje.Text = "No hay información de importación.";
                                }
                                else
