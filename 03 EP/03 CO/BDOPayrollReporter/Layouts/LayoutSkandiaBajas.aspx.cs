...
{
    public partial class LayoutSkandiaBajas : System.Web.UI.Page
    {
                ...
                if (Utilities.IsNumeric(this.DropDownListAño.SelectedValue))
                {
                    if (Utilities.IsNumeric(this.DropDownListPeriodo.SelectedValue))
                    {
                        ...
                        if (Utilities.ValidarAño(año))
                        {
                            ...
                            {
                                file = TextHelper.RenderLayoutSkandiaBajas(año, mes);

                                if (file.Length > 0)
                                {
                                    this.LabelMensaje.Text = "";
                                    Response.Clear();
                                    string fileName = Utilities.GetName(ReportName.Layoutdebajasskandia, año, mes);
