<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteImportesGravadosExcentos.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteImportesGravadosExcentos" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Listado de gravados y excentos</h2>
            <table width="100%">
                <tr>
                    <td colspan="2">
                        Para determinar IETU.
                    </td>
                </tr>
                <tr>
                    <td>
