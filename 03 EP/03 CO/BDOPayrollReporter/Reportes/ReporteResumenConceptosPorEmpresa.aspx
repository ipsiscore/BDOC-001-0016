<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteResumenConceptosPorEmpresa.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteResumenConceptosPorEmpresa" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Resumen de Conceptos por Empresa</h2>
            <table width="100%">
                <tr>
                    <td>
                        Año:
