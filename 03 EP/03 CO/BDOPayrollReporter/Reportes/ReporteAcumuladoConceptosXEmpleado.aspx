<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAcumuladoConceptosXEmpleado.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteAcumuladoConceptosXEmpleado" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Acumulados de Conceptos por Empleado</h2>
            <table width="100%">
                <tr>
                    <td colspan="2">
                        Para el reporte mensual a finanzas.
                    </td>
                </tr>
                <tr>
                    <td>
