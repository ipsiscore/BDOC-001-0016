<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteControlCambioNomina.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteControlCambioNomina" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Control de Cambios en Nómina</h2>
            <table width="100%">
                <tr>
                    <td colspan="2">
                        Reporte solicitado por SOX.
                    </td>
                </tr>
                <tr>
                    <td>
