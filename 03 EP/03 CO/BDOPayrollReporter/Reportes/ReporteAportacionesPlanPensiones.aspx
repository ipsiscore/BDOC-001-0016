<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAportacionesPlanPensiones.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteAportacionesPlanPensiones" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Acumulado de Plan de Pensiones</h2>
            <table width="100%">
                <tr>
                    <td colspan="2">
                        Desgloce por empleado.
                    </td>
                </tr>
                <tr>
                    <td>
