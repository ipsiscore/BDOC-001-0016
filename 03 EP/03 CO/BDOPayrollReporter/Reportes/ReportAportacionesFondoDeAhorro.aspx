<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportAportacionesFondoDeAhorro.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReportAportacionesFondoDeAhorro" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Reporte de Aportaciones Fondo de Ahorro</h2>
            <table width="100%">
                <tr>
                    <td>
                        Año:
            ...
            <rsweb:ReportViewer runat="server" ID="ReportViewerReporte" runat="server" ProcessingMode="Local"
