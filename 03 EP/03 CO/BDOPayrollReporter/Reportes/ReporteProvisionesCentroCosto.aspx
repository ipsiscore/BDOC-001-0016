<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteProvisionesCentroCosto.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteProvisionesCentroCosto" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Provisiones por Centro de Costos</h2>
            <table width="100%">
                <tr>
                    <td colspan="2">
                        Para finanzas el cuadre mensual.
                    </td>
                </tr>
                <tr>
                    <td>
