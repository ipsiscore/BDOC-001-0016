<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteImpuestoNomina.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteImpuestoNomina" MasterPageFile="~/MasterPages/Default.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Reporte Impuesto Sobre la Nómina</h2>
            <div id="lblValues">
            </div>
            <table width="100%">
                <tr>
