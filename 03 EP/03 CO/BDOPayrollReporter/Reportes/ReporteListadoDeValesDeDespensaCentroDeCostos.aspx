<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteListadoDeValesDeDespensaCentroDeCostos.aspx.cs"
    Inherits="BDOPayrollReporter.Reportes.ReporteListadoDeValesDeDespensaCentroDeCostos"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="righthalf">
        <div id="content" style="height: auto; width: auto; background-color: #FFFFFF;">
            <h2>
                Listado de Vales de Despensa (Centro de Costos)</h2>
            <table width="100%">
                <tr>
                    <td>
                        Año:
